...
import com.barath.app.utils.PropertyResolverUtility;
		...
		entities.entrySet().forEach( entry -> {
			...
			propertyMap.entrySet().forEach( propEntry -> {
				...
				if(relationDetails !=null && !relationDetails.isEmpty()){
					...
					relationDetails.put("fetchType",PropertyResolverUtility.resolveCascadeTypes((String)relationDetails.get("fetchType")));
